      ...
      <div className="mx-auto w-[95%] sm:w-[98%] max-w-7xl py-4 px-2 sm:px-4">
        <div className="flex items-center justify-between relative">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 md:static md:translate-x-0 md:translate-y-0 text-xl sm:text-2xl font-bold text-rose-700 whitespace-nowrap">LetHerBloom</span>
          </Link>
